...
import { type BaseCommentsConfig, BaseCommentsPlugin } from '@udecode/plate-comments'
...
export const commentsPlugin = toTPlatePlugin<CommentsConfig>(BaseCommentsPlugin, {
    handlers: {
