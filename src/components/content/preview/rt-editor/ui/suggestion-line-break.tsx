...
import { type SuggestionConfig, suggestionPlugin } from '@/components/content/preview/rt-editor/suggestion-plugin'
...
function SuggestionLineBreak({ suggestionData }: { suggestionData: TSuggestionData }) {
