...
import { Popover, PopoverTrigger } from '@/components/content/preview/rt-editor/ui/popover'
...
export function InlineEquationElement(props: PlateElementProps<TEquationElement>) {
    ...
    return (
        <PlateElement {...props} className={cn('mx-1 inline-block rounded-sm select-none [&_.katex-display]:my-0!')}>
