...
import { type AnyPluginConfig, type NodeEntry, type Path, type TElement, PathApi, TextApi } from '@udecode/plate'
...
export const BlockComment = ({ discussion, isLast }: { discussion: TDiscussion; isLast: boolean }) => {
